        ...
        private void btn_DangKy_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string insertQuery = "INSERT INTO TaiKhoan (TenDangNhap, MatKhau, SoDienThoai, HoVaTen, Email) VALUES (@TenDn, @MK, @SDT,@HoVaTen, @Email)";
                    ...
                    cmd.Parameters.AddWithValue("@HoVaTen", txt_ten.Text);
